...
from pjx.engine import EngineProtocol, create_engine
...
class PJX:
    ...
    def render(
        ...
        self._compile_template(template, css_parts)
    ...
    def _compile_template(
        self, template: str, css_parts: list[str] | None = None
    ) -> None:
        ...
        self._compile_imports(component, css_parts)

    def _compile_imports(self, component: Any, css_parts: list[str] | None) -> None:
        ...
        for imp in component.imports:
            ...
            self._compile_imports(imp_component, css_parts)
